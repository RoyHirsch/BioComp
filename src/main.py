...
def _main(numOfRuns=1):
	...
	ini_yaronAUPR = [0,0.594610698,0.514773825,0.4717869,0.341958113,0.250109638,0.246641534,0.239458146,0.237103258,
	...
	for sample in range(numOfRuns):
		...
		top_predictions = (predictions[sample][selex_num-1,:]*1.8 + predictions[sample][selex_num-2,:]*1.3 +
						   predictions[sample][selex_num-3,:]*1)/(1.8+1.3+1)
		print('average AUPR:')
